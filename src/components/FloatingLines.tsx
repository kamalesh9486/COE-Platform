...
void main() {
  ...
  float alpha = clamp(dot(color.rgb, vec3(0.299, 0.587, 0.114)) * 6.0, 0.0, 1.0);
  gl_FragColor = vec4(color.rgb, alpha);
}
`

const MAX_GRADIENT_STOPS = 8
const DEFAULT_WAVES: readonly ('top' | 'middle' | 'bottom')[] = ['top', 'middle', 'bottom']
...
interface FloatingLinesProps {
  ...
  enabledWaves?: readonly ('top' | 'middle' | 'bottom')[]
